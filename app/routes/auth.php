...
//Route::get('/register-company', [RegisteredUserController::class, 'create'])->middleware('guest')->name('register');

//Route::post('/register-company', [RegisteredUserController::class, 'store'])->middleware('guest');
